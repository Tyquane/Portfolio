import pygame # import pygame from pygame import mixer (This is how the game is importing it's pygame modules and sounds)
from pygame import mixer # import math import random (This is needed to for the advance math functions in the game)
import math
import random
...
while running:
    ...
    pygame.display.update() # The command: pygame.display.update() is constantly refreshing the image so that the player can see images and movement on the screen
